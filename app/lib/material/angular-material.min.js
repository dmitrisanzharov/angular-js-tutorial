...
!(function (B, de, se) {
    ...
    de.module('ngMaterial', [
            ...
            function e(s, d, n, a, e, t, r, o, l, c) {
                ...
                var f = {
                    ...
                    bidiProperty: function (e, t, n, o) {
                        var i = !('rtl' == s[0].dir || 'rtl' == s[0].body.dir),
                            r = de.element(e);
                        i && de.isDefined(t) ? (r.css(t, h(o)), r.css(n, '')) : !i && de.isDefined(n) && (r.css(n, h(o)), r.css(t, ''));
                    },
                        ...
                        var d = s[0].body,
                            ...
                            i = (function (e) {
                                ...
                                (e = de.element(e || d)),
                                    o.disableScrollMask
                                        ? (t = e)
                                        : ((t = de.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>')), e.append(t));
                                return (
                                    t.on('wheel', n),
                                    t.on('touchmove', n),
                                    function () {
                                        t.off('wheel'), t.off('touchmove'), !o.disableScrollMask && t[0].parentNode && t[0].parentNode.removeChild(t[0]);
                                    }
                                );
                                function n(e) {
                                    e.preventDefault();
                    ...
                    forceFocus: function (e) {
                        ...
                        t.initMouseEvent('click', !1, !0, B, {}, 0, 0, 0, 0, !1, !1, !1, !1, 0, null), (t.$material = !0), (t.$focus = !0), n.dispatchEvent(t);
                    },
                    ...
                    reconnectScope: function (e) {
                        if (e && e.$root !== e && e.$$disconnected) {
                            ...
                            (t.$$disconnected = !1),
                                ...
                                n.$$childHead ? ((n.$$childTail.$$nextSibling = t), (n.$$childTail = t)) : (n.$$childHead = n.$$childTail = t);
                        }
                    },
                    ...
                    elementContains: function (t, n) {
                        return (
                            B.Node && B.Node.prototype && Node.prototype.contains
                    ...
                    extractElementByName: function (e, o, t, n) {
                        var i = d(e);
                        return !i && n && r.warn(f.supplant("Unable to find node '{0}' in element '{1}'.", [o, e[0].outerHTML])), de.element(i || e);
                        function d(e) {
                            return (
                                (function (e) {
                        ...
                        (function (e, t) {
                            ...
                            if (n)
                                for (var i = e.childNodes, r = 0; r < i.length; r++) {
                                    ...
                                    1 === a.nodeType &&
                                        a.hasAttribute(t) &&
                                        (void 0, 'none' !== ((d = a).currentStyle ? d.currentStyle : s.getComputedStyle(d)).display && (o = !0));
                                }
                            var d;
                            return o;
                        })(o, t) ||
            ...
            function e(r) {
                ...
                (this.respectPreAssignBindingsEnabled = function (e) {
                        ...
                        return (
                            ...
                            this.$q.all(n).then(function (e) {
                                var t = a(e.$$ngTemplate, o),
                                    n = o.element || de.element('<div>').html(t.trim()).contents();
                    ...
                    (d.prototype._createController = function (e, t, n) {
                        ...
                        if (
                            !a ||
                            ('function' == typeof r.preAssignBindingsEnabled ? r.preAssignBindingsEnabled() : 1 === de.version.major && de.version.minor < 6)
                        ) {
                ...
                var t = navigator.userAgent || navigator.vendor || B.opera,
                    ...
                    s = {
                        ...
                        register: function (e, t, n) {
                            ...
                            if (!o) throw new Error('Failed to register element with handler ' + t + '. Available handlers: ' + Object.keys(c).join(', '));
                ...
                return (
                    s.isHijackingClicks &&
                        ...
                        s.handler('focus', {
                            ...
                            onEnd: function (e, t) {
                                t.distance < this.state.options.maxDistance && b(e.target) && (this.dispatchEvent(e, 'focus', t), e.target.focus());
                            },
                        }),
                    ...
                    s
                        ...
                        .handler('drag', {
                                    ...
                                    this.state.dragPointer
                                        ...
                                        : (this.state.options.horizontal
                                              ? ((n = Math.abs(t.distanceX) > this.state.options.minDistance),
                                                (o = Math.abs(t.distanceY) > this.state.options.minDistance * this.state.options.cancelMultiplier))
                            ...
                            dispatchDragMove: e.throttle(function (e) {
                                this.state.isRunning && (f(e, this.state.dragPointer), this.dispatchEvent(e, '$md.drag', this.state.dragPointer));
                            }),
                            onEnd: function (e, t) {
                                this.state.dragPointer && (f(e, this.state.dragPointer), this.dispatchEvent(e, '$md.dragend', this.state.dragPointer));
                            },
                        })
                        .handler('swipe', {
                            ...
                            onEnd: function (e, t) {
                                var n;
                                Math.abs(t.velocityX) > this.state.options.minVelocity && Math.abs(t.distanceX) > this.state.options.minDistance
                        ...
                        (t.prototype = {
                            ...
                            start: function (e, t) {
                                if (!this.state.isRunning) {
                                    ...
                                    (this.state = { isRunning: !0, options: de.extend({}, this.options, o), registeredParent: n }), this.onStart(e, t);
                                }
                            },
                            move: function (e, t) {
                    ...
                    switch (e.replace(s, '')) {
                        ...
                        case 'layout-align':
                            var o =
                                ...
                                (r = i.toLowerCase().trim().replace(m, '-').split('-')).length && 'space' === r[0] && (r = [r[0] + '-' + r[1], r[2]]),
                                ...
                                function o(e, t, n) {
                                    var o,
                                        ...
                                        a =
                                            ...
                                            function (e) {
                                                var t = C(i, e || '');
                                                de.isDefined(t) && (r && o.removeClass(r), (r = t ? i + '-' + t.trim().replace(m, '-') : i), o.addClass(r));
                                            }),
        ...
        (function (E) {
            ...
            var h,
                s = {},
                d = { name: 'dark', 1: 'rgba(0,0,0,0.87)', 2: 'rgba(0,0,0,0.54)', 3: 'rgba(0,0,0,0.38)', 4: 'rgba(0,0,0,0.12)' },
                l = { name: 'light', 1: 'rgba(255,255,255,1.0)', 2: 'rgba(255,255,255,0.7)', 3: 'rgba(255,255,255,0.5)', 4: 'rgba(255,255,255,0.12)' },
            ...
            function t(e, s) {
                ...
                return (n = {
                    ...
                    configuration: function () {
                        return E.extend({}, y, { defaultTheme: p, alwaysWatchTheme: u, registeredStyles: [].concat(y.registeredStyles) });
                    },
            ...
            function w(e, t) {
                return e
                    ? (4 == e.length && ((e = E.copy(e)), t ? e.pop() : (t = e.pop())),
                      t && ('number' == typeof t || ('string' == typeof t && t.length)) ? 'rgba(' + e.join(',') + ',' + t + ')' : 'rgb(' + e.join(',') + ')')
                    : "rgb('0,0,0')";
            }
        })(B.angular),
        (function () {
                        ...
                        return {
                            ...
                            $get: [
                                ...
                                function (o) {
                                    return {
                                        attach: function (e, t, n) {
                                            return i || t.controller('mdNoInk') ? de.noop : o.instantiate(r, { $scope: e, $element: t, rippleOptions: n });
                                        },
                                    };
                                },
                            ],
                    ...
                    return (
                        ...
                        (c = {
                            translate3d: function (t, n, e, o) {
                                return r(t, { from: n, to: e, addClass: o.transitionInClass, removeClass: o.transitionOutClass, duration: o.duration })
                                    .start()
                                    .then(function () {
                                        return i;
                                    });
                            ...
                            waitTransitionEnd: function (r, a) {
                                ...
                                return t(function (t, e) {
                                    var n;
                                    ('0s' == (n = (n = (a = a || {}).cachedTransitionStyles) || B.getComputedStyle(r[0])).transitionDuration ||
                            ...
                            calculateTransformValues: function (e, t) {
                                ...
                                if (i || r) {
                                    var a = i
                                            ? c.clientRect(i) || ((n = e ? e.parent() : null), (o = n ? n.parent() : null) ? c.clientRect(o) : null)
                                            : c.copyRect(r),
                            ...
                            calculateZoomToOrigin: function (e, t) {
                                var n = de.bind(null, o.supplant, 'translate3d( {centerX}px, {centerY}px, 0 ) scale( {scaleX}, {scaleY} )');
                            ...
                            toCss: function (e) {
                                ...
                                return (
                                    de.forEach(e, function (e, t) {
                                        if (!de.isUndefined(e))
                                            if (0 <= 'left top right bottom width height x y min-width min-height max-width max-height'.indexOf(t))
                                                o[t] = e + 'px';
                                            else
                                                switch (t) {
                                                    case 'transition':
        ...
        de.module('material.components.autocomplete', ['material.core', 'material.components.icon', 'material.components.virtualRepeat']),
                        ...
                        t.pin && t.pin(i, n),
                            m(function () {
                                ...
                                if (t.length) {
                                    ...
                                    'static' === n.position && c.warn('<md-backdrop> may not work properly in a scrolled, static-positioned parent container.'),
                                        d.inherit(i, t);
                                }
                            });
                    },
                        ...
                        onShow: function (e, t, n, o) {
                            ...
                            n.isLockedOpen
                                ...
                                : (n.cleanupGestures = (function (o, e) {
                                      ...
                                      return (
                                          e.on('$md.dragstart', n).on('$md.drag', i).on('$md.dragend', r),
                                          function () {
                            ...
                            return i.enter(t, n.parent, u).then(function () {
                                var e =
                                    d.findFocusTarget(t) ||
                                    de.element(t[0].querySelector('button') || t[0].querySelector('a') || t[0].querySelector(d.prefixer('ng-click', !0))) ||
                                    u;
                                n.escapeToClose &&
        ...
        (function () {
            ...
            (t.$inject = ['$mdButtonInkRipple', '$mdTheming', '$mdAria', '$mdInteraction']),
                (e.$inject = ['$mdTheming']),
                de.module('material.components.button', ['material.core']).directive('mdButton', t).directive('a', e);
        })(),
        (function () {
            function e(o) {
                return {
                                        ...
                                        b(n),
                                            ...
                                            n
                                                ...
                                                .on('keypress', function (e) {
                                                    ...
                                                    (t !== g.KEY_CODE.SPACE && t !== g.KEY_CODE.ENTER) || (e.preventDefault(), n.addClass('md-focused'), u(e));
                                                })
                                                .on('focus', function () {
                    ...
                    return {
                        ...
                        hue: (function (e, t) {
                            ...
                            if ('hue' === e[1]) {
                                ...
                                if (o < 1 || 3 < o)
                                    throw new Error(
                                        a.supplant("mdColors: 'hue-{hueNumber}' is not a valid hue, can be only 'hue-1', 'hue-2' and 'hue-3'", { hueNumber: o })
                                    );
                                if (((e[1] = 'hue-' + o), !(e[0] in n)))
                                    throw new Error(
                                        a.supplant("mdColors: 'hue-x' can only be used with [{availableThemes}], but was used with '{usedTheme}'", {
        ...
        (function () {
            ...
            function t(e) {
                ...
                return (
                    ...
                    e('$mdDialog')
                        ...
                        .addPreset('alert', { methods: ['title', 'htmlContent', 'textContent', 'content', 'ariaLabel', 'ok', 'theme', 'css'], options: t })
                        .addPreset('confirm', {
                ...
                function o(u, s, p, h, l, c, f, m, g, a, t, d, b) {
                    return {
                            ...
                            return (
                                (function (e) {
                                    function t(e, t) {
                                        ...
                                        if (n && n.length) {
                                            ...
                                            return de.extend(t || {}, {
                                                element: o ? n : se,
                                                bounds: o ? n[0].getBoundingClientRect() : de.extend({}, { top: 0, left: 0, height: 0, width: 0 }, n[0]),
                                    ...
                                    (e.origin = de.extend({ element: null, bounds: null, focus: de.noop }, e.origin || {})),
                                        ...
                                        e.targetEvent && ((e.origin = t(e.targetEvent.target, e.origin)), (e.originInteraction = b.getLastInteractionType()));
                                })(n),
                                (function (e, t) {
                                    ...
                                    $.addEventListener('focus', a), y.addEventListener('focus', a), e[0].parentNode.insertBefore($, e[0]), e.after(y);
                                })(i, n),
                                (r = e),
                                (a = t),
                                (d = n),
                                d.disableParentScroll && (d.restoreScroll = p.disableScrollAround(a, d.parent)),
                                d.hasBackdrop && ((d.backdrop = p.createBackdrop(r, 'md-dialog-backdrop md-opaque')), l.enter(d.backdrop, d.parent)),
                                ...
                                (function (e, t) {
                                            ...
                                            return (
                                                (t.reverseAnimate = function () {
                                                    return (
                                                        ...
                                                        t.closeTo
                                                            ? ((r = { transitionInClass: 'md-transition-out', transitionOutClass: 'md-transition-in' }),
                                                              (a = d),
                                    ...
                                    !(function (e, t) {
                                                ...
                                                var t = (function (e) {
                                                        for (var t = []; e.parentNode; ) {
                                                            ...
                                                            for (var n = e.parentNode.children, o = 0; o < n.length; o++)
                                                                e === n[o] || E(n[o], ['SCRIPT', 'STYLE']) || n[o].hasAttribute('aria-live') || t.push(n[o]);
                                                            e = e.parentNode;
                                                        }
                                                        return t;
                                                    })(e),
                                        ...
                                        (function () {
                                            if (n.focusOnOpen) {
                                                var e = p.findFocusTarget(t) || t[0].querySelector('.dialog-close, md-dialog-actions button:last-child') || i;
                                                e.focus();
                                            }
                                        })();
                                })
                        ...
                        onRemove: function (e, t, n) {
                            n.deactivateListeners(), n.unlockScreenReader(), n.hideBackdrop(n.$destroy), $ && $.parentNode && $.parentNode.removeChild($);
                        ...
                        transformTemplate: function (e, t) {
                            ...
                            return (
                                ...
                                '>' +
                                ((n = e), t.autoWrap && !/<\/md-dialog>/g.test(n) ? '<md-dialog>' + (n || '') + '</md-dialog>' : n || '') +
                                '</div>'
                            );
                        },
                    };
            ...
            (e.$inject = ['$$rAF', '$mdTheming', '$mdDialog']),
                (t.$inject = ['$$interimElementProvider']),
                de.module('material.components.dialog', ['material.core', 'material.components.backdrop']).directive('mdDialog', e).provider('$mdDialog', t);
        })(),
        (function () {
            function e(e) {
        ...
        (function () {
            function e(t, r, a, d, s, i) {
                ...
                function n(e) {
                    var t, n, o;
                    'click' == e.type &&
                        ((n = (t = e).target), d.getClosest(n, 'md-fab-trigger') && c.toggle(), (o = t.target), d.getClosest(o, 'md-fab-actions') && c.close()),
                        'focusout' != e.type ||
                            l ||
                            (l = i(
                                function () {
        ...
        (function () {
            ...
            de.module('material.components.fabSpeedDial', ['material.core', 'material.components.fabShared', 'material.components.fabActions'])
        ...
        (function () {
            ...
            de.module('material.components.fabToolbar', ['material.core', 'material.components.fabShared', 'material.components.fabActions'])
                                        ...
                                        return {
                                            ...
                                            position: (function (e, t) {
                                                ...
                                                var n = 0,
                                                    o = 0;
                                                for (; o - n < e.col; )
                                                    i <= r ? s() : -1 !== (n = d.indexOf(0, r)) && -1 !== (o = c(n + 1)) ? (r = o + 1) : ((n = o = 0), s());
                        ...
                        'input' === i && 'number' === p.type && p.min && p.max && !p.step
                            ...
                            : 'textarea' === i &&
                              (function () {
                                      ...
                                      ((function () {
                                          if (!p.hasOwnProperty('mdNoResize')) {
                                              ...
                                              u.wrap('<div class="md-resize-wrapper">').after(e),
                                                  e.on('mousedown', r),
                                                  o.on('$md.dragstart', a).on('$md.drag', d).on('$md.dragend', s),
                                                  m.$on('$destroy', function () {
                                                      e.off('mousedown', r).remove(),
                                                          o.off('$md.dragstart', a).off('$md.drag', d).off('$md.dragend', s),
                                                          i(),
                                                          (i = o = e = null);
                                                  });
                                          }
                                          function r(e) {
                                              e.preventDefault(), (t = !0), e.clientY, (n = parseFloat(u.css('height')) || u.prop('offsetHeight'));
                                          }
                                          function a(e) {
                                  ...
                                  function l() {
                                      if (t && ((t = !1), de.element(v).off('resize', o), n && n(), u.attr('md-no-autogrow', '').off('input', o), f)) {
                ...
                return {
                    ...
                    link: function (e, o, t, n) {
                        ...
                        var r,
                            ...
                            c = 'password' === t.type;
                        function m(e) {
                            return ((e = l && !c && de.isString(e) ? e.trim() : e) !== se && null !== e) || (e = ''), String(e).length;
                        }
                        function u() {
                        ...
                        e.$watch(t.mdMaxlength, function (e) {
                            ...
                            (d.$validators['md-maxlength'] = function (e, t) {
                                ...
                                u();
                                var n = o.val() || t;
                                return (n !== se && null !== n) || (n = ''), (n = l && !c && de.isString(n) ? n.trim() : n), String(n).length <= i;
                            }),
        ...
        (function () {
                ...
                return {
                    ...
                    compile: function (r, a) {
                        var e,
                            ...
                            o = r;
                        if ((r[0].setAttribute('role', 'listitem'), a.ngClick || a.ngDblclick || a.ngHref || a.href || a.uiSref || a.ngAttrUiSref)) l('button');
                        ...
                        function l(e) {
                            if ('div' == e) (o = de.element('<div class="md-no-style md-list-item-inner">')).append(r.contents()), r.addClass('md-proxy-focus');
                            else {
                                ...
                                c(r[0], t[0]),
                                    ...
                                    o.prepend(t),
                                    o.children().eq(1).append(r.contents()),
                        ...
                        return (
                            ...
                            de.forEach(n, function (e) {
                                !(function (e, t) {
                                    if (e && 'MD-BUTTON' != (o = e.nodeName.toUpperCase()) && 'BUTTON' != o && e.hasAttribute('ng-click')) {
                            ...
                            function (e, i, t, n) {
                                ...
                                r &&
                                    ...
                                    (1 == o.length || d) &&
                                        (i.addClass('md-clickable'), d || n.attachRipple(e, de.element(i[0].querySelector('.md-no-style')))),
                                    o.length &&
                                                ...
                                                if (
                                                    ...
                                                    !e &&
                                                        ...
                                                        de.forEach(o, function (e) {
                                                            t.target === e ||
                                                                e.contains(t.target) ||
                                                                ('MD-MENU' === e.nodeName && (e = e.children[0]), de.element(e).triggerHandler('click'));
                                                        });
                                                }
                                            });
                                e.$on('$destroy', function () {
            ...
            (n.$inject = ['$scope', '$element', '$mdListInkRipple']),
                ...
                de.module('material.components.list', ['material.core']).controller('MdListController', n).directive('mdList', e).directive('mdListItem', t);
        })(),
                ...
                return {
                    ...
                    template: function (e, t) {
                        ...
                        if (i !== se && null !== i) n = 'ng-click="ctrl.mdNavClick()"';
                            ...
                            if (a === se || null === a)
                                throw Error('Please specify at least one of the md-nav-click, md-nav-href, or md-nav-sref attributes per nav-item directive.');
                    ...
                    link: function (n, o, i, r) {
                        ...
                        e(function () {
                            if (
                                ...
                                d.name || (d.name = de.element(o[0].querySelector('._md-nav-button-text')).text().trim()),
        ...
        (function () {
            (d.$inject = ['presets', '$rootElement', '$rootScope', '$injector', '$window']),
                de.module('material.components.panel', ['material.core', 'material.components.backdrop']).provider('$mdPanel', function () {
                    return {
                        definePreset: e,
                        getAllPresets: t,
                        clearPresets: o,
            ...
            (d.prototype.create = function (e, t) {
                if (
                    ('string' == typeof e ? (e = this._getPresetByName(e)) : 'object' != typeof e || (!de.isUndefined(t) && t) || ((t = e), (e = {})),
                    (e = e || {}),
                    (t = t || {}),
                ...
                this._config = de.extend(
                    { id: t.id || 'panel_' + this._$mdUtil.nextUid(), scope: this._$rootScope.$new(!0), attachTo: this._$rootElement },
                    this._defaultConfigOptions,
                    t,
                    e
                );
                ...
                (s.prototype.close = function (r) {
                    ...
                    return this._$q(function (o, i) {
                        a._callInterceptors(s.interceptorTypes.CLOSE).then(function () {
                            ...
                            (n = de.bind(a, n, a, r)), a.hide().then(t).then(e).then(n).catch(i);
                        }, i);
                    });
                }),
                        ...
                        this._$q(function (e, t) {
                            ...
                            o._$q
                                .all([
                                    ...
                                    o._topFocusTrap && o._topFocusTrap.parentNode && o._topFocusTrap.parentNode.removeChild(o._topFocusTrap),
                                    o._bottomFocusTrap && o._bottomFocusTrap.parentNode && o._bottomFocusTrap.parentNode.removeChild(o._bottomFocusTrap),
                        ...
                        n.config.locals || (n.config.locals = {}),
                            (n.config.locals.mdPanelRef = n)._compile().then(function () {
                                n.config.disableParentScroll &&
                                    (n._restoreScroll = n._$mdUtil.disableScrollAround(null, n.panelContainer, { disableScrollMask: !0 })),
                        ...
                        var t,
                            ...
                            i = function (e) {
                                o.config.propagateContainerEvents
                                    ...
                                    : t === n[0] && e.target === n[0] && (e.stopPropagation(), e.preventDefault(), o.close(s.closeReasons.CLICK_OUTSIDE));
                            };
                        n.on('mousedown', e),
                            n.on('mouseup', i),
                            this._removeListeners.push(function () {
                ...
                (h.yPosition = { CENTER: 'center', ALIGN_TOPS: 'align-tops', ALIGN_BOTTOMS: 'align-bottoms', ABOVE: 'above', BELOW: 'below' }),
                ...
                (h.prototype._setPanelPosition = function (e) {
                    if ((e.removeClass('_md-panel-position-adjusted'), this._absolute)) this._setTransform(e);
                        ...
                        if (this._actualPosition)
                            return this._calculatePanelPosition(e, this._actualPosition), this._setTransform(e), void this._constrainToViewport(e);
                ...
                (l.animation = { SLIDE: 'md-panel-animate-slide', SCALE: 'md-panel-animate-scale', FADE: 'md-panel-animate-fade' }),
        ...
        (function () {
            ...
            (e.$inject = ['$mdUtil', '$mdConstant', '$mdTheming', '$timeout']),
                ...
                de.module('material.components.radioButton', ['material.core']).directive('mdRadioGroup', e).directive('mdRadioButton', t);
        })(),
        (function () {
            function e(m, u, e) {
                var p = 'determinate',
        ...
        (function () {
                            ...
                            (u.$render = function () {
                                ...
                                f ||
                                    ...
                                    n.on('blur', function (e) {
                                        l && ((l = !1), d._mdSelectIsOpen && e.stopImmediatePropagation()), d._mdSelectIsOpen || (c && c.setFocused(!1), T());
                                    })),
                                ...
                                r.$observe('disabled', function (e) {
                                    de.isString(e) && (e = !0),
                                        (t !== se && t === e) ||
                                            ((t = e)
                                                ? n.attr({ 'aria-disabled': 'true' }).removeAttr('tabindex').off('click', w).off('keydown', A)
                                                : n.attr({ tabindex: r.tabindex, 'aria-disabled': 'false' }).on('click', w).on('keydown', A));
                                }),
                                r.hasOwnProperty('disabled') ||
                                    r.hasOwnProperty('ngDisabled') ||
                                    (n.attr({ 'aria-disabled': 'false' }), n.on('click', w), n.on('keydown', A));
                            var C = { role: 'listbox', 'aria-expanded': 'false', 'aria-multiselectable': _ && !r.ngMultiple ? 'true' : 'false' };
                    ...
                    (d.optNodeForKeyboardSearch = function (e) {
                        ...
                        (d.addOption = function (e, t) {
                            if (de.isDefined(d.options[e]))
                                throw new Error('Duplicate md-option values are not allowed in a select. Duplicate value "' + t.value + '" found.');
                            (d.options[e] = t),
                                de.isDefined(d.selected[e]) &&
                                    (d.select(e, t.value),
                                    de.isDefined(d.ngModel.$modelValue) && d.hashGetter(d.ngModel.$modelValue) === e && d.ngModel.$validate(),
                                    d.refreshViewValue());
                        }),
                    ...
                    l(t),
                        ...
                        r.$$postDigest(function () {
                            e.$observe('selected', function (e) {
                                de.isDefined(e) &&
                                    ('string' == typeof e && (e = !0),
                                    e ? (d.isMultiple || d.deselect(Object.keys(d.selected)[0]), d.select(a.hashKey, a.value)) : d.deselect(a.hashKey),
                                    d.refreshViewValue());
                            });
                        }),
                        o.attach(r, t),
            ...
            function o(e) {
                return (
                    (t.$inject = ['$mdSelect', '$mdConstant', '$mdUtil', '$window', '$q', '$$rAF', '$animateCss', '$animate', '$document']),
                ...
                function t(c, m, H, O, r, u, p, h, P) {
                        ...
                        onShow: function (a, d, s) {
                            return (
                                ...
                                (function (e, t) {
                                    ...
                                    if (!t.target)
                                        throw new Error(H.supplant("$mdSelect.show() expected a target element in options.target but got '{0}'!", [t.target]));
                                    de.extend(t, {
                                        isRemoved: !1,
                                ...
                                (s.hideBackdrop =
                                    ...
                                    function () {
                                        o.backdrop && o.backdrop.remove(), o.disableParentScroll && o.restoreScroll(), delete o.restoreScroll;
                                    })),
                                ((n = d),
                                (e = s),
                                e.parent !== n.parent() && n.parent().attr('aria-owns', n.attr('id')),
                                n.parent().find('md-select-value').attr('aria-hidden', 'true'),
                                e.parent.append(n),
                                r(function (e, t) {
                                    try {
                                        p(n, { removeClass: 'md-leave', duration: 0 }).start().then(i).then(e);
                                    } catch (e) {
                                        t(e);
                                    }
                                })).then(function (e) {
                            ...
                            function i() {
                                return r(function (e) {
                                    ...
                                    t.container.element.css(f.toCss(t.container.styles)),
                                        ...
                                        u(function () {
                                            d.addClass('md-active'), t.dropDown.element.css(f.toCss({ transform: '' })), l(s.focusedNode), e();
                                        });
                                });
                            }
                            function l(e) {
                    ...
                    function b(e, t, n) {
                        var o,
                            ...
                            u = { left: c.left + R, top: R, bottom: c.height - R, right: c.width - R - (H.floatingScrollbars() ? 16 : 0) },
                            p = m.top - u.top,
                ...
                function t(r, a, e, t) {
                    ...
                    e.mdDisableScrollTarget &&
                        ((u = A[0].querySelector(e.mdDisableScrollTarget))
                            ? (u = de.element(u))
                            : M.warn(
                                  v.supplant('mdSidenav: couldn\'t find element matching selector "{selector}". Falling back to parent.', {
                                      selector: e.mdDisableScrollTarget,
                                  })
                              )),
                        u || (u = a.parent()),
                        e.hasOwnProperty('mdDisableBackdrop') || (s = v.createBackdrop(r, 'md-sidenav-backdrop md-opaque ng-enter')),
                        ...
                        r.$watch(
                            ...
                            function (e, t) {
                                (r.isLockedOpen = e) === t ? a.toggleClass('md-locked-open', !!e) : y[e ? 'addClass' : 'removeClass'](a, 'md-locked-open');
                        ...
                        r.$watch('isOpen', function (e) {
                            ...
                            return (
                                (i = e),
                                i && !d ? ((d = u.css('overflow')), u.css('overflow', 'hidden')) : de.isDefined(d) && (u.css('overflow', d), (d = se)),
                                (h = T.all([e && s ? y.enter(s, o) : s ? y.leave(s) : T.when(!0), y[e ? 'removeClass' : 'addClass'](a, 'md-closed')]).then(
                                    function () {
                                        r.isOpen &&
                                            (_(function () {
        ...
        (function () {
            (e.$inject = ['$$rAF', '$window', '$mdAria', '$mdUtil', '$mdConstant', '$mdTheming', '$mdGesture', '$parse', '$log', '$timeout']),
                de
            ...
            function e(z, W, i, V, Y, K, G, X, Q, Z) {
                ...
                function r(i, r, e, t) {
                        ...
                        p
                            ...
                            .on('mousedown', function () {
                                (function () {
                                    ...
                                    M || ((M = de.element('<canvas>').css('position', 'absolute')), u.append(M), (T = M[0].getContext('2d')));
                                    var n,
                                        o = D();
                    ...
                    function P(e, t, n) {
                        if (de.isNumber(e)) return (t = de.isNumber(t) ? t : E), (n = de.isNumber(n) ? n : $), Math.max(t, Math.min(n, e));
                    }
                    function L(e) {
                        if (de.isNumber(e)) {
        ...
        (function () {
                            ...
                            i ||
                                ((i = (function (e) {
                                    ...
                                    function n(e, t) {
                                        e &&
                                            e.state !== t &&
                                            (e.state && (e.clone.attr('sticky-prev-state', e.state), e.element.attr('sticky-prev-state', e.state)),
                                    ...
                                    function s(e, t) {
                                        e &&
                                            (null === t || t === se
                                                ...
                                                : ((e.translateY = t),
                                                  m.bidi(e.clone, l.CSS.TRANSFORM, 'translate3d(' + e.left + 'px,' + t + 'px,0)', 'translateY(' + t + 'px)')));
                                    }
                                })(o)),
            ...
            (e.$inject = ['$mdConstant', '$$rAF', '$mdUtil', '$compile']),
                de.module('material.components.sticky', ['material.core', 'material.components.content']).factory('$mdSticky', e);
        })(),
        (function () {
            ...
            (e.$inject = ['$mdSticky', '$compile', '$mdTheming', '$mdUtil', '$mdAria']),
                de.module('material.components.subheader', ['material.core', 'material.components.sticky']).directive('mdSubheader', e);
        })(),
        (function () {
            function e(e) {
                t.$inject = ['$parse'];
        ...
        (function () {
                        ...
                        return (
                            ...
                            function (n, o, e, t) {
                                ...
                                h(function () {
                                    ...
                                    s
                                        .on('$md.dragstart', function (e) {
                                            (r && r(n)) || (e.stopPropagation(), o.addClass('md-dragging'), (a = { width: d.prop('offsetWidth') }));
                                        })
                                        .on('$md.drag', function (e) {
                                            if (a) {
            ...
            (e.$inject = ['mdCheckboxDirective', '$mdUtil', '$mdConstant', '$parse', '$$rAF', '$mdGesture', '$timeout']),
                de.module('material.components.switch', ['material.core', 'material.components.checkbox']).directive('mdSwitch', e);
        })(),
        ...
        (function () {
            ...
            function t(e) {
                ...
                return e('$mdToast')
                    .setDefaults({ methods: ['position', 'hideDelay', 'capsule', 'parent', 'position', 'toastClass'], options: o })
                    .addPreset('simple', {
                    ...
                    return {
                        onShow: function (e, i, r) {
                            ...
                            (i = s.extractElementByName(i, 'md-toast', !0)),
                                ...
                                (r.openClass =
                                    ((t = r.position), l('gt-xs') ? 'md-toast-open-' + (-1 < t.indexOf('top') ? 'top' : 'bottom') : 'md-toast-open-bottom')),
            ...
            (e.$inject = ['$mdToast']),
                (t.$inject = ['$$interimElementProvider']),
                de.module('material.components.toast', ['material.core', 'material.components.button']).directive('mdToast', e).provider('$mdToast', t);
        })(),
        (function () {
            ...
            (e.$inject = ['$$rAF', '$mdConstant', '$mdUtil', '$mdTheming', '$animate']),
                de.module('material.components.toolbar', ['material.core', 'material.components.content']).directive('mdToolbar', e);
        })(),
        (function () {
                    ...
                    link: function (a, o, d) {
                        ...
                        function f() {
                            t(),
                                ...
                                (e = k[a.mdDirection]),
                                (r = T.newPanelPosition().relativeTo(m).addPanelPosition(e.x, e.y)),
                                ...
                                ? (function () {
                                      ...
                                      if (!s) {
                                          var e = de.element(document.body),
                                              t = T.newPanelAnimation().openFrom(m).closeTo(m).withAnimation({ open: 'md-show', close: 'md-hide' }),
                                              n = {
                                                  id: c,
                                                  attachTo: e,
                                                  contentElement: o,
                        ...
                        t(),
                            ...
                            (function () {
                                ...
                                function i() {
                                    ((a.hasOwnProperty('mdAutohide') ? a.mdAutohide : d.hasOwnProperty('mdAutohide')) || p || y[0].activeElement !== m[0]) &&
            ...
            (e.$inject = ['$timeout', '$window', '$$rAF', '$document', '$interpolate', '$mdUtil', '$mdPanel', '$$mdTooltipRegistry']),
                de
        ...
        (function () {
            ...
            (t.$inject = ['$$rAF', '$mdUtil', '$mdConstant', '$parse', '$rootScope', '$window', '$scope', '$element', '$attrs']),
                ...
                (t.prototype.handleScroll_ = function () {
                    ...
                    if (!(t === this.scrollOffset || t > this.scrollSize - this.size)) {
                        ...
                        if (n) {
                            ...
                            if (
                                ((this.scrollOffset = t), (this.offsetter.style.webkitTransform = i), (this.offsetter.style.transform = i), this.bindTopIndex)
                            ) {
                                var r = Math.floor(t / n);
                                r !== this.topIndex &&
                                    r < this.repeater.getItemCount() &&
                                    ((this.topIndex = r), this.bindTopIndex.assign(this.$scope, r), this.$rootScope.$$phase || this.$scope.$digest());
                            }
                            this.repeater.containerUpdated();
                        }
                    }
                ...
                return {
                    link: function (e, n, o) {
                        ...
                        o.$observe('mdWhiteframe', function (e) {
                            -1 != (e = parseInt(e, 10) || 4) &&
                                (24 < e || e < 1) &&
                                (r.warn('md-whiteframe attribute value is invalid. It should be a number between 1 and 24', n[0]), (e = 4));
            ...
            function e(u, p, h, t, n, e, o, i, f, d, r, a) {
                    ...
                    (m.keydown = function (e) {
                        switch (e.keyCode) {
                            case t.KEY_CODE.DOWN_ARROW:
                                ...
                                e.stopPropagation(), e.preventDefault(), (m.index = Math.min(m.index + 1, m.matches.length - 1)), Q(), X(!1, k.Selected);
                                break;
                            ...
                            case t.KEY_CODE.ESCAPE:
                                if ((e.preventDefault(), !(U('blur') || !m.hidden || m.loading || (U('clear') && u.searchText)))) return;
                                e.stopPropagation(),
                                    K(),
                ...
                return (
                    ...
                    void h.nextTick(function () {
                        ...
                        (e = (function () {
                            ...
                            if (e.length) return { snap: e[0], wrap: 'width' === t.toLowerCase() ? e[0] : p.find('md-autocomplete-wrap')[0] };
                ...
                function N() {
                    ...
                    if (
                        ...
                        (e = { left: d + 'px', minWidth: s + 'px', maxWidth: Math.max(n.right - i.left, i.right - n.left) - re + 'px' }),
                        'top' === c)
                    )
                    ...
                    x(),
                        o
                            ...
                            : i &&
                              u.searchText &&
                              L(i).then(function (e) {
                                  de.isString(u.searchText) && e.toString().toLowerCase() === u.searchText.toLowerCase() && (u.searchText = '');
                              }),
                ...
                function L(e) {
                    return d.when(((t = e), (t && u.itemText ? u.itemText(R(t)) : null) || e)).then(function (e) {
                        return (
                            e &&
                                !de.isString(e) &&
                                r.warn('md-autocomplete: Could not resolve display value to a string. Please check the `md-item-text` attribute.'),
                            e
                        );
                    });
                    var t;
                ...
                function G() {
                    ...
                    e.initCustomEvent('change', !0, !0, { value: '' }), v.input.dispatchEvent(e), v.input.blur(), (u.searchText = ''), v.input.focus();
                }
                function X(e, t) {
                ...
                return {
                    ...
                    compile: function (e, n) {
                        ...
                        return (
                            ...
                            function (e, t, n, o) {
                                (o.hasNotFound = !!t.attr('md-has-not-found')), de.isDefined(n.mdClearButton) || e.floatingLabel || (e.clearButton = !0);
                            }
                        );
                    },
                    template: function (n, e) {
                        var t,
                            ...
                            i =
                                ...
                                (o = t.length ? t.html() : '')
                                    ? '<li ng-if="$mdAutocompleteCtrl.notFoundVisible()"                         md-autocomplete-parent-scope>' + o + '</li>'
                                    : ''),
                            r = (function () {
            ...
            (e.$inject = ['$scope', '$element', '$mdConstant', '$timeout', '$mdUtil']),
                ...
                (e.prototype.selectNodeContents = function (e) {
                    ...
                    document.body.createTextRange
                        ...
                        : B.getSelection && ((n = B.getSelection()), (t = document.createRange()).selectNodeContents(e), n.removeAllRanges(), n.addRange(t));
                }),
                ...
                (e.prototype.chipKeyDown = function (e) {
                    this.isEditing || (e.keyCode !== this.$mdConstant.KEY_CODE.ENTER && e.keyCode !== this.$mdConstant.KEY_CODE.SPACE)
                        ? this.isEditing && e.keyCode === this.$mdConstant.KEY_CODE.ENTER && (e.preventDefault(), this.goOutOfEditMode())
        ...
        (function () {
            ...
            de.module('material.components.chips').controller('MdChipsCtrl', e),
                ...
                (e.prototype.removeChipAndFocusInput = function (e, t) {
                    this.removeChip(e, t),
                        this.autocompleteCtrl ? ((this.autocompleteCtrl.hidden = !0), this.$mdUtil.nextTick(this.onFocus.bind(this))) : this.onFocus();
                }),
            ...
            (e.$inject = ['$attrs', '$element', '$timeout']),
                ...
                (e.prototype.setupChipsAria = function () {
                    ...
                    this.removedMessage && (t.removedMessage = this.removedMessage),
                        ...
                        this.containerEmptyHint && (e.attr('container-empty-hint', this.containerEmptyHint), (t.containerEmptyHint = this.containerEmptyHint)),
                ...
                (e.prototype.setupAutocompleteAria = function () {
                    ...
                    this.inputAriaDescribedBy && e.attr('aria-describedby', this.inputAriaDescribedBy),
                        this.inputAriaLabelledBy && (e.removeAttr('aria-label'), e.attr('aria-labelledby', this.inputAriaLabelledBy));
                }),
        ...
        (function () {
            (e.$inject = ['$element', '$scope', '$$mdDateUtil', '$mdUtil', '$mdConstant', '$mdTheming', '$$rAF', '$attrs', '$mdDateLocale']),
        ...
        (function () {
            ...
            function t(e, t, n, o, i, r, a, d, s, l, c, m) {
                (this.$window = o),
                    ...
                    (this.windowEventName = p.test(navigator.userAgent || navigator.vendor || B.opera) ? 'orientationchange' : 'resize'),
                    ...
                    (this.leftMargin = 20),
                    (this.topMargin = null),
                    n.tabindex ? (this.ngInputElement.attr('tabindex', n.tabindex), n.$set('tabindex', null)) : n.$set('tabindex', '-1'),
            ...
            (t.prototype.$onInit = function () {
                ...
                (t.prototype.configureNgModel = function (e, t, n) {
                    ...
                    o.ngModelCtrl.$formatters.push(function (e) {
                        ...
                        if (!(e instanceof Date) && ((t = Date.parse(e)), !isNaN(t) && de.isNumber(t) && (e = new Date(t)), e && !(e instanceof Date)))
                            throw Error(
        ...
        (function () {
            ...
            function a(a, r, d, s, l, t) {
                            ...
                            ? d.when(
                                  (function (e) {
                                      var i,
                                          ...
                                          n = e.clone(),
                                          o = l.nextUid();
                                      if (!isFinite(Number(o))) throw new Error('Unsafe and unexpected non-number result from $mdUtil.nextUid().');
                ...
                function i(n) {
                    return function (e) {
                        var t;
                        return (o[n] = ((t = e), de.isDefined(t.element) && de.isDefined(t.config) ? e : new f(e, a[n]))), o[n].clone();
                    };
                }
                function u(e) {
                    var t = a[e];
                    ...
                    return m.test(e)
                        ...
                        : ((o = e),
                          d(function (t, n) {
                              r(o, !0).then(
                                  function (e) {
                                      c[o] || (c[o] = de.element('<div>').append(e)[0].querySelector('svg')), t(c[o]);
                                  },
                                  function (e) {
                ...
                function f(e, t) {
                    ...
                    e && 'svg' !== e.tagName.toLowerCase() && (e = de.element('<svg xmlns="http://www.w3.org/2000/svg">').append(e.cloneNode(!0))[0]),
            ...
            (e.prototype.init = function () {
                ...
                (e.prototype.disableOpenOnHover = function () {
                    this.openOnHoverEnabled &&
                        ...
                        this.parentToolbar &&
                            (this.parentToolbar.classList.remove('md-has-open-menu'), de.element(this.parentToolbar).off('click', this.handleParentClick)),
                ...
                (e.prototype.scheduleOpenMenu = function (e) {
                    ...
                    e != t.currentlyOpenMenu &&
                        ...
                        (t.pendingMenuOpen = n(
                            function () {
                                (t.pendingMenuOpen = se), t.currentlyOpenMenu && t.currentlyOpenMenu.close(!0, { closeAll: !0 }), e.open();
                            },
                            200,
                            !1
                        )));
                ...
                (e.prototype.handleKeyDown = function (e) {
                    ...
                    switch ((this.setKeyboardMode(!0), e.keyCode)) {
                        ...
                        case i.UP_ARROW:
                            ...
                            break;
                        case i.LEFT_ARROW:
                            (n = this.focusMenu(-1)), a && ((o = de.element(n).controller('mdMenu')), this.scheduleOpenMenu(o)), (t = !0);
                            break;
                        case i.RIGHT_ARROW:
                            (n = this.focusMenu(1)), a && ((o = de.element(n).controller('mdMenu')), this.scheduleOpenMenu(o)), (t = !0);
                    }
                ...
                (e.prototype.handleParentClick = function (e) {
                    ...
                    t && !t.contains(e.target) && de.element(t).controller('mdMenu').close(!0, { closeAll: !0 });
                });
        })(),
        (function () {
            function e(n, i) {
                ...
                (e.prototype.init = function (e) {
                    ...
                    (this.ngModel = e),
                        ('checkbox' != n.type && 'radio' != n.type) ||
                            ((this.mode = n.type), (this.iconEl = t[0].children[0]), (this.buttonEl = t[0].children[1]), e && this.initClickListeners());
                }),
            ...
            function e(i, t, r, a, d, o, e, n, s) {
                ...
                (this.nestLevel = parseInt(t.mdNestLevel, 10) || 0),
                    (this.init = function (e, t) {
                        (t = t || {}),
                            (l = e),
                            (c = r[0].querySelector(m.buildSelector(['ng-click', 'ng-mouseenter']))).setAttribute('aria-expanded', 'false'),
                ...
                (this.enableHoverListener = function () {
                    ...
                    (this.handleMenuItemHover = function (e) {
                        if (!u.isAlreadyOpening) {
                            ...
                            p = o(
                                function () {
                                    if ((t && (t = de.element(t).controller('mdMenu')), u.currentlyOpenMenu && u.currentlyOpenMenu != t)) {
                                        var e = u.nestLevel + 1;
                    ...
                    (this.open = function (e) {
                        e && e.stopPropagation(),
                            ...
                            u.isOpen ||
                                ...
                                a.$emit('$mdMenuOpen', r),
                                i
                                    .show({ scope: a, mdMenuCtrl: u, nestLevel: u.nestLevel, element: l, target: c, preserveElement: !0, parent: 'body' })
                                    .finally(function () {
                ...
                return {
                    ...
                    compile: function (e) {
                        ...
                        if (2 !== e.children().length)
                            throw Error(d + 'Expected two children elements. The second element must have a `md-menu-content` element.');
        ...
        (function () {
            function e(e) {
                ...
                function t(C, l, c, M, T, m, u, p, h, f) {
                    ...
                    return {
                                ...
                                (d.hideBackdrop =
                                    ...
                                    t.nestLevel
                                        ...
                                        : (t.disableParentScroll && !C.getClosest(t.target, 'MD-DIALOG')
                                          ...
                                          t.hasBackdrop &&
                                              ((t.backdrop = C.createBackdrop(e, 'md-menu-backdrop md-click-catcher')), h.enter(t.backdrop, M[0].body)),
                                          function () {
                                        ...
                                        (d.cleanupInteraction = (function () {
                                            ...
                                            function i(e) {
                                                ...
                                                switch (e.keyCode) {
                                                    ...
                                                    case c.KEY_CODE.UP_ARROW:
                                                        b(e, d.menuContentEl, d, -1) || d.nestLevel || d.mdMenuCtrl.triggerContainerProxy(e), (t = !0);
                                                        break;
                                            ...
                                            function r(e) {
                                                ...
                                                do {
                                                    ...
                                                    if (
                                                        (o(t, ['ng-click', 'ng-href', 'ui-sref']) || 'BUTTON' == t.nodeName || 'MD-BUTTON' == t.nodeName) &&
                        ...
                        onRemove: function (e, n, o) {
                            return (
                                ...
                                !0 === o.$destroy ? t() : p(n, { addClass: 'md-leave' }).start().then(t)
                            );
                            function t() {
                                var e, t;
                                n.removeClass('md-active'),
                                    (e = n),
                                    (t = o).preserveElement ? (i(e).style.display = 'none') : i(e).parentNode === i(t.parent) && i(t.parent).removeChild(i(e)),
                                    (o.alreadyOpen = !1);
                            }
                        },
                        hasBackdrop: !0,
                    ...
                    function b(e, t, n, o) {
                        for (
                            var i, r = C.getClosest(e.target, 'MD-MENU-ITEM'), a = C.nodesToArray(t[0].children), d = a.indexOf(r) + o;
                            0 <= d && d < a.length;
                            d += o
                        ) {
                    ...
                    function v(e, t) {
                        ...
                        ('target' !== p.top && 'target' !== p.left && 'target-right' !== p.left) ||
                            ((n = (function () {
                                ...
                                ((m = (n = (n = n.firstElementChild || n).querySelector(A.buildSelector('md-menu-align-target')) || n).getBoundingClientRect()),
        ...
        de.module('material.components.tabs').directive('mdTab', function () {
            return {
                ...
                compile: function (e, t) {
                    ...
                    if (
                        0 === n.length &&
                        ((n = de.element('<md-tab-label></md-tab-label>')), t.label ? n.text(t.label) : n.append(e.contents()), 0 === o.length)
                    ) {
        ...
        (function () {
            function e(l, c, n, o, i, m, s, r, a, d, e, u, t) {
                ...
                function A(e) {
                    ...
                    (n = n.replace('--', '')), de.element(t.paging).css(o.CSS.TRANSFORM, 'translate(' + n + ', 0)'), l.$broadcast('$mdTabsPaginationChanged');
                }
                function w(e, t) {
                    e !== t && D().tabs[e] && (j(), B());
                }
                ...
                function j(e) {
                    ...
                    if ((de.isNumber(e) || (e = p.focusIndex), t.tabs[e] && !p.shouldCenterTabs)) {
                        ...
                        if (0 !== e)
                            ...
                            } else (p.offsetLeft = Math.max(p.offsetLeft, W(i - t.canvas.clientWidth + 32))), (p.offsetLeft = Math.min(p.offsetLeft, W(o)));
                        else p.offsetLeft = 0;
                    }
                }
                function U() {
                ...
                function q() {
                    ...
                    if (r !== i) {
                        'bottom' === c.attr('md-align-tabs') && ((r -= o), (i -= o), c.attr('md-border-bottom') !== se && ++r), (h = !0);
                        var a = { height: r + 'px' },
                            d = { height: i + 'px' };
                        c.css(a),
                ...
                (p.$onInit = function () {
                    ...
                    (p.removeTab = function (e) {
                        ...
                        U(), p.selectedIndex === t && (n.scope.deselect(), p.tabs[p.selectedIndex] && p.tabs[p.selectedIndex].scope.select());
                        m.nextTick(function () {
